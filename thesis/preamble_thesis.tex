...
\newcommand*{\getPrintLocationEN}{Munich}       % Ort der Erstellung
\newcommand*{\getPrintYearEN}{\the\year}          % Jahr der Erstellung
\newcommand*{\getPlaceOfBirthEN}{Gifhorn}
\newcommand*{\getSubmissionDateEN}{14.03.2023}
\newcommand*{\langEN}{en-US}
% -- german -- %
\newcommand{\getTitleDE}{Abschätzung kosmologischer Parameter im $\Lambda$CDM- and DGP-Modell anhand von Supernovae Typ Ia Daten}
\newcommand{\getSubtitleDE}{maybe with some subtitle}
\newcommand*{\getPrintLocationDE}{München}       % Ort der Erstellung
\newcommand*{\getPrintYearDE}{\the\year}          % Jahr der Erstellung
\newcommand*{\getPlaceOfBirthDE}{Gifhorn}
\newcommand*{\getSubmissionDateDE}{14.03.2023}
%\newcommand*{\langDE}{de}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%% COMMAND FOR BACKGROUND PICTURE %%%
% -- have a look at https://tex.stackexchange.com/questions/86500/includegraphics-set-image-opacity -- %
...
%%% CSQUOTES SETUP %%%
% have a look at https://tex.stackexchange.com/questions/329334/quote-inline-with-italics
...
%%% TITLESEC SETUP %%%
% have a look at https://tex.stackexchange.com/questions/111643/decrease-space-before-and-after-chapter-in-fncychap
\makeatletter
