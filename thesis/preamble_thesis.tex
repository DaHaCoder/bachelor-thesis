...
\usepackage[english]{babel}                                         %   for english language -- https://www.ctan.org/pkg/babel
...
\newcommand{\getTitle}{Title of the thesis}
\newcommand{\getSubtitle}{maybe with some subtitle}
\newcommand*{\getAuthor}{Danial Hagemann}
\newcommand*{\getPrintLocation}{Munich}       % Ort der Erstellung
\newcommand*{\getPrintYear}{\the\year}          % Jahr der Erstellung
\newcommand*{\getPlaceOfBirth}{Gifhorn}
\newcommand*{\getSubmissionDate}{Submission date in the dean's office}
