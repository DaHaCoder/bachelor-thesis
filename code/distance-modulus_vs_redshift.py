...
def main():    
    ...
    fig.savefig('../thesis/figures/plots/EPS/distance-modulus_vs_redshift.eps', format='eps', bbox_inches='tight')
    fig.savefig('../thesis/figures/plots/PNG/distance-modulus_vs_redshift.png', format='png', bbox_inches='tight', dpi=250)
    fig.savefig('../thesis/figures/plots/PDF/distance-modulus_vs_redshift.pdf', format='pdf', bbox_inches='tight')
    # tikzplotlib.save('../thesis/figures/tikz/distance-modulus_vs_redshift.tex')
