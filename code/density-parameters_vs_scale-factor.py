...
def main():
    ...
    fig.savefig('../thesis/figures/plots/PNG/density-parameters_vs_scale-factor.png', format = 'png', bbox_inches = 'tight', dpi = 400)
    fig.savefig('../thesis/figures/plots/PDF/density-parameters_vs_scale-factor.pdf', format = 'pdf', bbox_inches = 'tight')
    # tikzplotlib.save('../thesis/figures/tikz/plots/density-parameters_vs_scale-factor.tex')
