...
def main():
    ...
    plt.suptitle('$\\texttt{Lambda-CDM_marginalized_likelihood.py}$', fontsize=20)
    plt.title('fit values: ($\mu_{{m,0}}, \sigma_{{m,0}}) = ({0:.2f},{1:.2f})$'.format(*popt_m0))
    plt.grid(True) 
    plt.show()
    
    # fig.savefig('../thesis/figures/plots/EPS/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_likelihood_summed_Omega_Lambda0.eps', format = 'eps', bbox_inches = 'tight')
    fig.savefig('../thesis/figures/plots/PNG/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_likelihood_summed_Omega_Lambda0.png', format = 'png', bbox_inches = 'tight', dpi = 250)
    # fig.savefig('../thesis/figures/plots/PDF/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_likelihood_summed_Omega_Lambda0.pdf', format = 'pdf', bbox_inches = 'tight')
    # tikzplotlib.save('../thesis/figures/tikz/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_likelihood_summed_Omega_Lambda0.tex')
    ...
    # fig.savefig('../thesis/figures/plots/EPS/[Lambda-CDM_marginalized_likelihood]_Omega_Lambda0_vs_likelihood_summed_Omega_m0.eps', format = 'eps', bbox_inches = 'tight')
    fig.savefig('../thesis/figures/plots/PNG/[Lambda-CDM_marginalized_likelihood]_Omega_Lambda0_vs_likelihood_summed_Omega_m0.png', format = 'png', bbox_inches = 'tight', dpi = 250)
    # fig.savefig('../thesis/figures/plots/PDF/[Lambda-CDM_marginalized_likelihood]_Omega_Lambda0_vs_likelihood_summed_Omega_m0.pdf', format = 'pdf', bbox_inches = 'tight')
    # tikzplotlib.save('../thesis/figures/tikz/[Lambda-CDM_marginalized_likelihood]_Omega_Lambda0_vs_likelihood_summed_Omega_m0.tex')
    # ================================================================================================
    ...
    # --- save fig ---
    # fig.savefig('../thesis/figures/plots/EPS/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_Omega_Lambda0_vs_likelihood.eps', format = 'eps', bbox_inches = 'tight')
    fig.savefig('../thesis/figures/plots/PNG/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_Omega_Lambda0_vs_likelihood.png', format = 'png', bbox_inches = 'tight', dpi = 250)
    # fig.savefig('../thesis/figures/plots/PDF/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_Omega_Lambda0_vs_likelihood.pdf', format = 'pdf', bbox_inches = 'tight')
    # tikzplotlib.save('../thesis/figures/tikz/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_Omega_Lambda0_vs_likelihood.tex')
    ...
    # --- save fig ---
    # fig.savefig('../thesis/figures/plots/EPS/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_Omega_Lambda0.eps', format = 'eps', bbox_inches = 'tight')
    fig.savefig('../thesis/figures/plots/PNG/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_Omega_Lambda0.png', format = 'png', bbox_inches = 'tight', dpi = 250)
    # fig.savefig('../thesis/figures/plots/PDF/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_Omega_Lambda0.pdf', format = 'pdf', bbox_inches = 'tight')
    # tikzplotlib.save('../thesis/figures/tikz/[Lambda-CDM_marginalized_likelihood]_Omega_m0_vs_Omega_Lambda0.tex')
    # ===================================================================
