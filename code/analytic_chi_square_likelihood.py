...
# @njit
def likelihood(i, j, Omega_m0, Omega_Lambda0, redshifts, magnitudes, error_magnitudes):
    ...
    return i, j, np.exp(-0.5 * chi_2)


# def normalization_factor(LIST_Omega_m0, LIST_Omega_Lambda0, redshifts, magnitudes, error_magnitudes):
    ...
    # L = lambda Omega_m0, Omega_Lambda0: likelihood(i, j, Omega_m0, Omega_Lambda0, redshifts, magnitudes, error_magnitudes)[2]
...
def MATRIX_likelihood(LIST_Omega_m0, LIST_Omega_Lambda0, redshifts, magnitudes, error_magnitudes):
    ...
    with Pool() as pool:
        for i, j, L in pool.starmap(likelihood, likelihood_args):
            MATRIX[i, j] = L
...
def main():
    ...
    # === Computation of Omega_m0 vs. likelihood with summed Omega_Lambda0 and vice versa ===
    # =======================================================================================
    ...
    # --- save fig ---
    # fig.savefig('../thesis/figures/plots/EPS/[analytic_chi_square_likelihood]_Omega_m0_vs_likelihood_summed_Omega_Lambda0.eps', format = 'eps', bbox_inches = 'tight')
    fig.savefig('../thesis/figures/plots/PNG/[analytic_chi_square_likelihood]_Omega_m0_vs_likelihood_summed_Omega_Lambda0.png', format = 'png', bbox_inches = 'tight', dpi = 250)
    ...
    # --- save fig ---
    # fig.savefig('../thesis/figures/plots/EPS/[analytic_chi_square_likelihood]_Omega_Lambda0_vs_likelihood_summed_Omega_m0.eps', format = 'eps', bbox_inches = 'tight')
    fig.savefig('../thesis/figures/plots/PNG/[analytic_chi_square_likelihood]_Omega_Lambda0_vs_likelihood_summed_Omega_m0.png', format = 'png', bbox_inches = 'tight', dpi = 250)
    # fig.savefig('../thesis/figures/plots/PDF/[analytic_chi_square_likelihood]_Omega_Lambda0_vs_likelihood_summed_Omega_m0.pdf', format = 'pdf', bbox_inches = 'tight')
    # tikzplotlib.save('../thesis/figures/tikz/[analytic_chi_square_likelihood]_Omega_Lambda0_vs_likelihood_summed_Omega_m0.tex')
    # =======================================================================================




    # === Computation of Omega_m0 vs. likelihood at Omega_Lambda0_best and vice versa ===
    # ===================================================================================

    # --- create list of Omega_m0 for which likelihood is at Omega_Lambda0_best ---
    LIST_Omega_m0_at_Omega_Lambda0_index = MATRIX_like[Omega_Lambda0_index, :]
    # --- create list of Omega_Lambda0 for which likelihood is at Omega_m0_best ---
    ...
    # --- save fig ---
    # fig.savefig('../thesis/figures/plots/EPS/[analytic_chi_square_likelihood]_Omega_m0_vs_likelihood_at_Omega_Lambda0_best.eps', format = 'eps', bbox_inches = 'tight')
    fig.savefig('../thesis/figures/plots/PNG/[analytic_chi_square_likelihood]_Omega_m0_vs_likelihood_at_Omega_Lambda0_best.png', format = 'png', bbox_inches = 'tight', dpi = 250)
    ...
    # --- save fig ---
    # fig.savefig('../thesis/figures/plots/EPS/[analytic_chi_square_likelihood]_Omega_Lambda0_vs_likelihood_at_Omega_m0_best.eps', format = 'eps', bbox_inches = 'tight')
    fig.savefig('../thesis/figures/plots/PNG/[analytic_chi_square_likelihood]_Omega_Lambda0_vs_likelihood_at_Omega_m0_best.png', format = 'png', bbox_inches = 'tight', dpi = 250)
    # fig.savefig('../thesis/figures/plots/PDF/[analytic_chi_square_likelihood]_Omega_Lambda0_vs_likelihood_at_Omega_m0_best.pdf', format = 'pdf', bbox_inches = 'tight')
    # tikzplotlib.save('../thesis/figures/tikz/[analytic_chi_square_likelihood]_Omega_Lambda0_vs_likelihood_at_Omega_m0_best.tex')
    # ===================================================================================
    ...
    # --- save fig ---
    # fig.savefig('../thesis/figures/plots/EPS/[analytic_chi_square_likelihood]_Omega_m0_vs_Omega_Lambda0_vs_likelihood.eps', format = 'eps', bbox_inches = 'tight')
    fig.savefig('../thesis/figures/plots/PNG/[analytic_chi_square_likelihood]_Omega_m0_vs_Omega_Lambda0_vs_likelihood.png', format = 'png', bbox_inches = 'tight', dpi = 250)
    # fig.savefig('../thesis/figures/plots/PDF/[analytic_chi_square_likelihood]_Omega_m0_vs_Omega_Lambda0_vs_likelihood.pdf', format = 'pdf', bbox_inches = 'tight')
    # tikzplotlib.save('../thesis/figures/tikz/[analytic_chi_square_likelihood]_Omega_m0_vs_Omega_Lambda0_vs_likelihood.tex')
    ...
    # --- save fig ---
    # fig.savefig('../thesis/figures/plots/EPS/[analytic_chi_square_likelihood]_Omega_m0_vs_Omega_Lambda0.eps', format = 'eps', bbox_inches = 'tight')
    fig.savefig('../thesis/figures/plots/PNG/[analytic_chi_square_likelihood]_Omega_m0_vs_Omega_Lambda0.png', format = 'png', bbox_inches = 'tight', dpi = 250)
    # fig.savefig('../thesis/figures/plots/PDF/[analytic_chi_square_likelihood]_Omega_m0_vs_Omega_Lambda0.pdf', format = 'pdf', bbox_inches = 'tight')
    # tikzplotlib.save('../thesis/figures/tikz/[analytic_chi_square_likelihood]_Omega_m0_vs_Omega_Lambda0.tex')
    # =========================================================
